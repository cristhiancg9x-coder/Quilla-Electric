...
import { c as createExports, s as serverEntrypointModule } from './chunks/_@astrojs-ssr-adapter_CuxrZKsy.mjs';
import { manifest } from './manifest_BHXjbd2t.mjs';
...
const _page6 = () => import('./pages/cotizador.astro.mjs');
const _page7 = () => import('./pages/electricista-en/_lugar_.astro.mjs');
...
const _page11 = () => import('./pages/servicios/_---slug_.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/cotizador.astro", _page6],
    ["src/pages/electricista-en/[lugar].astro", _page7],
    ["src/pages/login.astro", _page8],
    ["src/pages/rss.xml.js", _page9],
    ["src/pages/servicios/index.astro", _page10],
    ["src/pages/servicios/[...slug].astro", _page11],
...
const _args = {
    "middlewareSecret": "673a287b-fd98-409e-a3f1-cc150ca56b51",

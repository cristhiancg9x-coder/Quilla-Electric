import { o as objectType, h as dateType, i as arrayType, s as stringType, A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, j as escape, k as renderUniqueStylesheet, l as renderScriptElement, n as createHeadAndContent, r as renderComponent } from './astro/server_DjG7uRHx.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_Dh6EiusT.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_FIREBASE_API_KEY": "AIzaSyBtp5vRqrN1R3lwoinI1xz6Hdaup1OGKn4", "PUBLIC_FIREBASE_APP_ID": "1:777764083566:web:ad309f4fa8a25d66f4937f", "PUBLIC_FIREBASE_AUTH_DOMAIN": "quilla-electric-platform.firebaseapp.com", "PUBLIC_FIREBASE_MESSAGING_SENDER_ID": "777764083566", "PUBLIC_FIREBASE_PROJECT_ID": "quilla-electric-platform", "PUBLIC_FIREBASE_STORAGE_BUCKET": "quilla-electric-platform.firebasestorage.app", "SITE": "https://quillaelectric.site", "SSR": true};
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_tpUHLAJk.mjs');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_D63QpVk_.mjs').then(n => n._);
